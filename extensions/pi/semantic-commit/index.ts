/**
 * Semantic Commit Extension - Create commits following Conventional Commits specification
 */

import type { ExtensionAPI } from "@mariozechner/pi-coding-agent";

const COMMIT_PROMPT = `# Semantic Commit
